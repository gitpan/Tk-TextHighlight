...
Don't show any of the CodeText menu items (combines B<-noSyntaxMenu>, 
...
This is a derived work from Tk::CodeText, by Hans Jeuken (haje@toneel.demon.nl)

Thanks go to Mr. Hans Jeuken for his great work in making this possible.
...
B<Tk::TextHighlight::HTML>, B<Tk::TextHighlight::Template>, B<Tk::TextHighlight::Bash>
